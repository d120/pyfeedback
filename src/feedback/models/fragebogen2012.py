...
class Ergebnis2012(Ergebnis):
    ...
    v_feedbackpreis_parts = ['v_4', 'v_5', 'v_6', 'v_7', 'v_8', 'v_9', 'v_10', 'v_11', 'v_12', 'v_13', 'v_14', 'v_15',
                             'v_16', 'v_gesamt']
    ...
    ue_feedbackpreis_parts = ['ue_4', 'ue_5', 'ue_6', 'ue_7', 'ue_8', 'ue_9', 'ue_11', 'ue_13', 'ue_14', 'ue_15',
                              'ue_gesamt']
