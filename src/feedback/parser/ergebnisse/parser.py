...
class Parser(object):
    ...
    def parse_abschluss(data):
        return Parser._mapping(
            {"1": "bsc", "2": "msc", "3": "dipl", "4": "lehr", "5": "sonst"}, data
        )

    @staticmethod
    def parse_abschluss_16(data):
        return Parser._mapping(
            {"1": "bsc", "2": "msc", "4": "lehr", "5": "sonst"}, data
        )
    ...
    def parse_veranstaltung_gehoert(data):
        return Parser._mapping({"1": "1", "3": "3", "2": "2", "4": "<=4"}, data)

    @staticmethod
    def parse_klausur_angetreten(data):
        return Parser._mapping({"1": "1", "0": "0", "2": "2"}, data)
