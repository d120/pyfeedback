...
from feedback.models import Semester, Veranstaltung, Fragebogen2008, Fragebogen2009, Fragebogen2012, Fragebogen2016, Fragebogen2020, Fragebogen2025
...
class ParserTest(TestCase):
    ...
    def test_parse_ergebnisse2020(self):
        self._do_parse_ergebnisse_test(20155, '2020', Fragebogen2020)
