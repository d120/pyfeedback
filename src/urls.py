...
if not settings.TESTING and settings.DEBUG and HAS_DEBUG_TOOLBAR:
    # avoided directly using debug_toolbar.urls(), as importing caused error in django-debug-toolbar v6.0.0 
